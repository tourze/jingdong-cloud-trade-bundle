...
use JingdongCloudTradeBundle\Controller\Admin\SkuCrudController;
...
class SkuCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /**
     * @return SkuCrudController<Sku>
     */
    ...
    {
        // Controller中使用TextField::new('baseInfo.skuId')，在表单中字段名会变为baseInfo_skuId
    ...
    public function testValidationErrors(): void
    {
        ...
        $this->assertStringContainsString('京东账户', $content);
